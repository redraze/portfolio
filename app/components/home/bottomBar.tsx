...
export default function BottomBar() {
    ...
    return (
        <nav aria-label="bottom-bar" className="flex justify-between bg-[#2b74c9] h-[2.6vh] min-h-[26px] items-center">
            {/* left-hand icons */}
            <div className="flex items-center h-full *:px-[0] gap-1">
                <div className={styles.group}>
                    ...
                    <span className={styles.tooltipLeft}>Open a remote window</span>
                </div>
                <div className={styles.group}>
                    <div className="flex items-center mx-1">
                        ...
                        <span className="mx-[5px] text-[14px]">main*</span>
                    ...
                    <span className={styles.tooltipLeft}>portfolio (Git) - main*, Checkout Branch/Tag...</span>
                </div>
                <div className={styles.group}>
                    <div className="flex items-center mx-[6px]">
                        ...
                        <span className="ml-1 text-[14px]">0</span>
                        <div className="flex items-center ml-1">
                    ...
                    <span className={styles.tooltip}>No Problems</span>
                </div>
            </div>
            ...
            <div className="flex items-center *:text-[13.5px] h-full">
                ...
                <div className="relative flex items-center h-full *:p-2 *:ml-1">
                    <div className={styles.group}>
                        ...
                        <span>Go Live</span>
                        <span className={styles.tooltipRight}>Click to run live server</span>
                    </div>
                    <div className={styles.group}>
                        ...
                        <span className={styles.tooltipRight}>No Notifications</span>
                    </div>
                </div>
            </div>
        </nav>
...
const styles = {
    group: "group cursor-pointer flex grow justify-center hover:bg-[#3e87dc] h-full items-center",
    tooltip: "hidden group-hover:flex absolute bottom-[25px] bg-[#252526] w-min whitespace-nowrap px-[9px] py-[3px] border-1 border-[#ffffff30] rounded-sm text-[14px] normalText",
    tooltipLeft: "left-0 hidden group-hover:flex absolute bottom-[25px] bg-[#252526] w-min whitespace-nowrap px-[9px] py-[3px] border-1 border-[#ffffff30] rounded-sm text-[14px] normalText",
    tooltipRight: "right-0 hidden group-hover:flex absolute bottom-[25px] bg-[#252526] w-min whitespace-nowrap px-[9px] py-[3px] border-1 border-[#ffffff30] rounded-sm text-[14px] normalText",
    iconColor: "#ffffff",
};
