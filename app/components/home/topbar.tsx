    ...
    return (
        <nav aria-label="top-bar" className="flex bg-[#3c3c3c] justify-between h-[40px]">
            ...
            <div className="w-0 flex items-center">
                <div className="flex items-center z-20 *:mx-[9px]">
            ...
            <div className="flex items-center py-[6px] w-[100%] justify-center">
                <div className="flex items-center *:mx-[4px] mx-1">
                    <div className="group flex justify-center items-center relative">
                        ...
                        <span className="hidden group-hover:block absolute z-20 top-[25px] bg-[#252526] w-min whitespace-nowrap px-2 py-[2px] border-1 border-[#ffffff30] rounded-sm text-[14px] normalText">
                ...
                <div className="flex group justify-center relative items-center h-full *:mx-1 px-[15%] mx-2 bg-[#464646] hover:bg-[#4d4d4d] border-[1.5px] border-solid border-[#ffffff25] hover:border-[#ffffff40] rounded-sm cursor-pointer z-20">
                    ...
                    <span className="hidden group-hover:block absolute z-20 top-[30px] bg-[#252526] w-min whitespace-nowrap px-2 py-[2px] border-1 border-[#ffffff30] rounded-sm text-[14px] normalText">
...
const styles = {
    ...
    tooltip: "hidden group-hover:block absolute z-20 top-[30px] bg-[#252526] w-min whitespace-nowrap px-2 py-[2px] border-1 border-[#ffffff30] rounded-sm text-[14px] normalText",
};
