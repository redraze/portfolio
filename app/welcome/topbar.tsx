export default function TopBar() {
    return (
        <nav aria-label="top-bar" className="flex bg-[#3c3c3c] justify-between top-toolbar-height">
            ...
            <div className="flex items-center py-[6px]">
                ...
                <div className="flex items-center h-full *:mx-1 px-75 mx-2 bg-[#464646] border-[1.5px] border-solid border-[#ffffff25] rounded-md">
                    <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke={styles.searchbarContentColor} strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    </div>
                    <span className={`text-[${styles.searchbarContentColor}] text-[14px]`}>Connor Ross</span>
                </div>
            </div>

            {/* right-hand icons */}
            <div className="w-0 flex relative">
                <div className="flex items-center absolute right-[-100%] top-toolbar-height">
