...
export const fileNameKeys = {
    KITCHEN: 'Kitchen.tsx',
    PAPER_TRADING: 'Paper_Trading.tsx',
    FREELANCE: 'Freelance.tsx',
...
export const folders: FolderType[] = [
    // {        
    //     foldername: folderNameKeys.GAMES,
    //     files: [
    //         {
    //             filename: 'tetris',
    //             icon: <></>,
    //             component: <></>,
    //             path: [folderNameKeys.GAMES],
    //         },
    //         {
    //             filename: 'snake',
    //             icon: <></>,
...
export const files: FileType[] = [
    {
        ...
        filename: fileNameKeys.TECHNOLOGIES,
        component: <Technologies />,
    },
    {
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#61dafba2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>,
        filename: fileNameKeys.ABOUTME,
        component: <AboutMe />,
    },
];
